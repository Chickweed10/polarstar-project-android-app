...
public class RealTimeLocationActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED &&
            ...
            startLocationUpdates(); // 3. 위치 업데이트
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( RealTimeLocationActivity.this, REQUIRED_PERMISSIONS,
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(RealTimeLocationActivity.this);
