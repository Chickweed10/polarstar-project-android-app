...
public class PermissionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private int permissionDeniedFlag = 0;
    private int backgroundPermissionDeniedFlag = 0;
    ...
    //백그라운드 위치 권한
    private void backgroundLocationPermission(){
        //백그라운드 위치 권한 없을 경우
        if(ActivityCompat.checkSelfPermission(this,android.Manifest.permission.ACCESS_BACKGROUND_LOCATION) != PackageManager.PERMISSION_GRANTED){
            ...
            btnOk.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    // 원하는 기능 구현
                    permissionDialog.dismiss(); // 다이얼로그 닫기
                    if(backgroundPermissionDeniedFlag > 1){
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull @NotNull String[] permissions, @NonNull @NotNull int[] grantResults) {
        ...
        if(requestCode == 1){
            if(grantResults[0] == -1){
                backgroundPermissionDeniedFlag++;
                Log.w(TAG, "플래그: " + backgroundPermissionDeniedFlag);
            }
        }
        ...
        if (!permission.permissionResult(requestCode, permissions, grantResults)){
            ...
            if(permissionDeniedFlag >0 && permissionDeniedFlag <= 1){
            ...
            else if(permissionDeniedFlag > 1 ){ //두 번 이상 거절한 경우
                permissionDialog = new PermissionDialog(PermissionActivity.this,
