...
import com.example.polarstarproject.MainActivity;
import com.example.polarstarproject.R;
...
public class ManualActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manualpage);

        viewPager = findViewById(R.id.view_pager);
        dotsLayout = findViewById(R.id.layoutDots);
        btnSkip = findViewById(R.id.manualBtnSkip);
        btnNext = findViewById(R.id.manualBtnNext);

        // 변화될 레이아웃들 주소
        // 원하는 경우 레이아웃을 몇 개 더 추가
        layouts = new int[]{
                R.layout.manual_page1,
                R.layout.manual_page2,
                R.layout.manual_page3,
                R.layout.manual_page4,
                R.layout.manual_page5
        };
